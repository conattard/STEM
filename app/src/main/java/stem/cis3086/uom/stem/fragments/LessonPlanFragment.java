        ...
        Ion.with(getActivity())
                ...
                .setCallback(new FutureCallback<JsonArray>() {
                    ...
                    public void onCompleted(Exception e, JsonArray result) {
                        ...
                        if (lessonPlan.has("ShortDescription") && !lessonPlan.get("ShortDescription").isJsonNull()) {
                        ...
                        if (lessonPlan.has("LessonFocus") && !lessonPlan.get("LessonFocus").isJsonNull()) {
                        ...
                        if (lessonPlan.has("LessonSynopsis") && !lessonPlan.get("LessonSynopsis").isJsonNull()) {
                        ...
                        if (lessonPlan.has("Objectives") && !lessonPlan.get("Objectives").isJsonNull()) {
                        ...
                        if (lessonPlan.has("LearnerOutcomes") && !lessonPlan.get("LearnerOutcomes").isJsonNull()) {
                        ...
                        if (lessonPlan.has("LessonActivities") && !lessonPlan.get("LessonActivities").isJsonNull()) {
                        ...
                        if (lessonPlan.has("Aligment") && !lessonPlan.get("Aligment").isJsonNull()) {
                        ...
                        if (lessonPlan.has("RecommendeReading") && !lessonPlan.get("RecommendeReading").isJsonNull()) {
                        ...
                        if (lessonPlan.has("OptionalActivities") && !lessonPlan.get("OptionalActivities").isJsonNull()) {
                        ...
                        if (lessonPlan.has("TeacherResources") && !lessonPlan.get("TeacherResources").isJsonNull()) {
                        ...
                        if (lessonPlan.has("StudentNotes") && !lessonPlan.get("StudentNotes").isJsonNull()) {
